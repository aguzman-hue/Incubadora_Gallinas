...
REM
REM Generated by Vivado on Mon Oct 20 19:40:51 -0600 2025
...
echo "xvlog --incr --relax -prj tb_permiso3_paseo_vlog.prj"
call xvlog  --incr --relax -prj tb_permiso3_paseo_vlog.prj -log xvlog.log
